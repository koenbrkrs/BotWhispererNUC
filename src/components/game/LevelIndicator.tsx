    ...
    <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 bg-black/80 backdrop-blur-md rounded-full px-6 py-2 border border-white/10">
      <div className="flex items-center gap-4">
        ...
        <button 
          ...
          className={`flex items-center gap-2 transition-all hover:opacity-100 ${currentLevel === 1 ? 'opacity-100' : 'opacity-50'}`}
        >
        ...
        <button 
          ...
          className={`flex items-center gap-2 transition-all hover:opacity-100 ${currentLevel === 3 ? 'opacity-100' : 'opacity-50'}`}
        >
